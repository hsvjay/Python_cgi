...
db1=db.cursor()
sql1="SELECT GEL_REPORT, SAMPLE_TYPE FROM REPORT WHERE SO_NUMBER='{}'".format(SO_NUMBER)
db1.execute(sql1)
...
if String_Value[0][0] !='YES':
    ...
    print '</html>'
db.close()
print "{} SO_NUMBER: {}, '{}', {}<br>".format(String_Value[0][1], SO_NUMBER, fn , path)
print '</body>'
print '</html>'
