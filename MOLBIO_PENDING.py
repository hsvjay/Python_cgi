...
def htmlTop():
    print("""Content-type: text/html\n\n
             ...
             <html lang="en">
                 ...
                 <body style="background-color:coral;">""").format("MolBio_pending_list")
...
def selectRecords(db, db1):
    sql= "SELECT * FROM REPORT WHERE SAMPLE_TYPE='NA' AND GEL_REPORT ='NA' AND BA_REPORT = 'NA' AND TABLE_REPORT = 'NA' AND MOL_RESULT ='NA';"
    db1.execute(sql)
    SO_LIST=db1.fetchall()
    return SO_LIST
    

def displayRecords(SO_LIST):
